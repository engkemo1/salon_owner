...
class EditSalon extends GetView<CreateSalonController> {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    TextFormWidget(textInputType: TextInputType.text, obscureText: false,controller:controller.salonName
                      ..text = CacheHelper.get(key: 'salonName') ?? '', validator: (value){validate(value);},),
                ...
                Column(
                  ...
                  children: [
                    ...
                    ..text = CacheHelper.get(key: 'salonAddress') ?? '',),
                ...
                Column(
                  ...
                  children: [
                    ...
                    TextFormWidget(textInputType: TextInputType.text, obscureText: false,validator: (value){
                      ...
                      ..text = CacheHelper.get(key: 'salonContact') ?? '',),
                          ...
                          child: Padding(
                            ...
                            child: TextFormWidget(
                              controller: controller.braids
                                ..text = CacheHelper.get(key: 'braids') ?? '',
                          ...
                          child: Padding(
                            ...
                            child: TextFormWidget(
                              controller:controller.abuja
                                ..text = CacheHelper.get(key: 'abuja') ?? '',
                              validator:(value){
                                validate(value);
                              },
                              textInputType: TextInputType.number,
                          ...
                          child: Padding(
                            ...
                            child: TextFormWidget(
                              controller: controller.hairCut
                                ..text = CacheHelper.get(key: 'hairCut') ?? '',
                              validator:(value){
                                validate(value);
                              },
                          ...
                          child: Padding(
                            ...
                            child: TextFormWidget(
                              controller:controller.blowDry
                                ..text = CacheHelper.get(key: 'blowDry') ?? '',
                              validator:(value){
                                validate(value);
                              },
                              textInputType: TextInputType.number,
                          ...
                          child: Padding(
                            ...
                            child: TextFormWidget(
                              controller:controller.relaxer
                                ..text = CacheHelper.get(key: 'relaxer') ?? '',
                              validator:(value){
                                validate(value);
                              },
                              textInputType: TextInputType.number,
                          ...
                          child: Padding(
                            ...
                            child: TextFormWidget(
                              controller:controller.manicure
                                ..text = CacheHelper.get(key: 'manicure') ?? '',
                              validator:(value){
                                validate(value);
                              },
                              textInputType: TextInputType.number,
                ...
                SizedBox(height: 20,),
                MyButton(btnText: 'save', onpressed: ()async{
